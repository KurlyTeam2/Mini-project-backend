...
public class ResponseMessage {
    ...
    public static final String READ_USER = "GET users success";
    public static final String NOT_FOUND_USER = "cannot find user";
    public static final String READ_WORK = "GET works success";
    public static final String NOT_FOUND_WORK = "cannot find work";
    public static final String CREATED_USER = "join success";
